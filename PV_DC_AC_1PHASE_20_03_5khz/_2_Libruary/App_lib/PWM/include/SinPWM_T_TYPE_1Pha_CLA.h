...
#define SPWM_T_TYPE_1Pha_V3_CLA_MARCO(v)							\
	 ...
	 /*Limit*/														\
	if (v.Ta1<0.0) v.Ta1 = 0.0; else if(v.Ta1>1.00) v.Ta1 = 1.00;	\
 	if (v.Tb1<0.0) v.Tb1 = 0.0; else if(v.Tb1>1.00) v.Tb1 = 1.00;	\
	if (v.Ta2<0.0) v.Ta2 = 0.0; else if(v.Ta2>1.00) v.Ta2 = 1.00;	\
	if (v.Tb2<0.0) v.Tb2 = 0.0; else if(v.Tb2>1.00) v.Tb2 = 1.00;	\
	/* Dao */														\
	v.Ta1 = 1.0 - v.Ta1;											\
	v.Tb2 = 1.0 - v.Tb2;
